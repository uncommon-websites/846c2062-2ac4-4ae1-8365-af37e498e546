...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Emily Shefferman",
		role: "Founder & Lead Instructor",
		image: "/generated/image-environmental-editorial-portrait-of-a-wo.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"I discovered yoga during a time when I felt disconnected from myself. That transformation—finding strength and peace through breath—showed me what's possible when we create truly welcoming spaces for people to begin their journey."`}
			/>
